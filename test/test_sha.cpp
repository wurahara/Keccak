...
TEST(TestSha, Keccak_F_1600) {
    constexpr std::array<uint64_t, keccak::core::P_LEN> state_first = {
    ...
    constexpr std::array<uint64_t, keccak::core::P_LEN> state_second = {
    ...
    std::array<uint64_t, keccak::core::P_LEN> state = {0};

    keccak::core::keccak_p(state);
